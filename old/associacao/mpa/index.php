...
// Corrigindo a busca do total para a Missão Pará Amapá (idAssociacao 67)
$total_local = '';
...
<div class="main-container">
    <div class="header-section">
        ...
        <h2 class="page-subtitle">Números de Assinaturas da Lição da Escola Sabatina na Missão Pará Amapá</h2>
    </div>
