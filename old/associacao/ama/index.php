...
<div class="main-container" id="conteudo">
    <div class="header-section">
        ...
        <h2 class="page-subtitle">Números de Assinaturas da Lição da Escola Sabatina na <span id="association-name">Associação Maranhense</span></h2>
    </div>
...
<script>
    ...
    async function carregarAPI() {
        try {
            ...
            const id = params.get('id') || 36; // Default to Associação Maranhense (id 36)
