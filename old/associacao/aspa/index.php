...
<div class="main-container" id="conteudo">
    <div class="header-section">
        ...
        <h2 class="page-subtitle">Números de Assinaturas da Lição da Escola Sabatina na <span id="association-name">Associação Sul do Pará</span></h2>
    </div>
...
<script>
    ...
    function preencherDados(data) {
        // Find the total number for the specific ID (Associação Sul do Pará is ID 37, index 2 in the first PHP's results)
        ...
        document.getElementById('association-name').textContent = 'Associação Sul do Pará';
    ...
    async function carregarAPI() {
        try {
            const id = 37; // For Associação Sul do Pará
