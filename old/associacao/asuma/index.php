...
$postData1 = array(
    ...
    'idAssociacao' => 0, // ID 0 para o relatório geral
    'tipoRelatorio' => 1
);
...
$Campo = "Associação Sul Maranhense";
$postData = array(
    'login' => 'unb',
    'senha' => '+zv!t{7t^EY5+[CaAssoc%d&#@Csep)*@!%#',
    'idAssociacao' => 40,
...
// Corrigindo a busca do total para a Associação Sul Maranhense (idAssociacao 40)
$total_local = '';
if (isset($responseData['results']) && is_array($responseData['results'])) {
    foreach ($responseData['results'] as $result) {
        // Encontra o total da associação procurando pelo item com "siglaAssociacao" = "Todos"
...
// Se o total não for encontrado, define como 0 para evitar erros
...
<div class="main-container">
    <div class="header-section">
        <h1 class="main-counter"><?php echo str_pad($total_local, 5, '0', STR_PAD_LEFT); ?></h1>
        <h2 class="page-subtitle">Números de Assinaturas da Lição da Escola Sabatina na Missão Oeste do Pará</h2>
    </div>
